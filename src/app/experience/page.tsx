    ...
    <>
      ...
      <section className="border-y border-surface-border bg-surface/50">
        <div className="mx-auto max-w-3xl px-6 py-16">
          ...
          <div
            style={{ boxShadow: "var(--card-shadow)" }}
            className="mt-8 rounded-xl border border-surface-border bg-background p-6"
          >
            <div className="flex flex-wrap items-baseline justify-between gap-2">
          ...
          <div
            style={{ boxShadow: "var(--card-shadow)" }}
            className="mt-6 rounded-xl border border-surface-border bg-background p-6"
          >
            <div className="flex flex-wrap items-baseline justify-between gap-2">
              <h3 className="text-lg font-semibold">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        >
          <ul className="list-disc space-y-2 pl-5 text-foreground-muted">
            ...
            <li>AI course — Ed Donner (in progress)</li>
          </ul>
        </div>
      </section>
    </>
