  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="relative mt-10 space-y-4 border-l-2 border-surface-border pl-8">
          <div className="group relative">
            ...
            <div className="-ml-4 rounded-lg p-4 transition-colors duration-300 group-hover:bg-surface">
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5 text-foreground-muted">
                ...
                <li>
                  Troubleshoot network connectivity issues and diagnose
                  devices on-site using Fing.
                </li>
                <li>
                  Configure routers and maintain client networks, responding
                  to and resolving outages.
                </li>
                <li>
                  Carry out PC builds, hardware repairs, and system upgrades.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="group relative">
            ...
            <div className="-ml-4 rounded-lg p-4 transition-colors duration-300 group-hover:bg-surface">
              ...
              <p className="mt-2 text-sm text-foreground-muted">
                ...
                2022–2025. Roles spanning hospitality, education, and
                emergency response, building customer service, teamwork, and
